...
import static com.example.translator.GlobalVars.LANGUAGE_CODES;
import static com.example.translator.GlobalVars.BASE_REQ_URL;
import static com.example.translator.GlobalVars.DEFAULT_LANG_POS;
...
//                Toast.makeText(getApplicationContext(), "This language speech pack needs to be installed", Toast.LENGTH_SHORT).show();
//            } else if (result == TextToSpeech.LANG_NOT_SUPPORTED) {
//                Toast.makeText(getApplicationContext(), "This language speech is currently not supported", Toast.LENGTH_SHORT).show();
//            }
